...
export function Onboarding3() {
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-between p-8 max-w-md mx-auto">
      ...
      <div className="flex-1 flex flex-col items-center justify-center text-center px-4">
        ...
        <div className="mb-12">
          ...
          <div className="flex items-end justify-center gap-8 mb-10">
            {[
              { stage: 'Start', height: 'h-20', color: 'bg-[#E5E7EB]', width: 'w-14' },
              { stage: 'Week 4', height: 'h-24', color: 'bg-[#4A90E2]', width: 'w-14' },
              { stage: 'Week 8', height: 'h-32', color: 'bg-[#2ECC71]', width: 'w-14' }
            ].map((stage, index) => (
        ...
        {/* Headline */}
        <h1 className="text-[32px] font-bold text-[#1F2933] mb-4 leading-[1.2] tracking-tight">
          See your evolution<br />every day
        </h1>
      ...
      <Link
        to="/onboarding-4"
        className="w-full bg-[#2ECC71] text-white py-[18px] rounded-[20px] font-semibold text-[17px] shadow-[0_8px_30px_rgba(46,204,113,0.25)] hover:bg-[#27AE60] active:scale-[0.98] transition-all"
      >
        Continue
      </Link>
    </div>
