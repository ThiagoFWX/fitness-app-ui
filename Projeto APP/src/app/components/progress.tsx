...
export function Progress() {
  ...
  const stats = [
    { label: "Current Streak", value: "5", unit: "days", icon: Target, color: "text-[#2ECC71]", bg: "bg-[#2ECC71]/10" },
    { label: "Total Workouts", value: "18", unit: "sessions", icon: Zap, color: "text-[#4A90E2]", bg: "bg-[#4A90E2]/10" },
    { label: "Active Days", value: "23", unit: "this month", icon: Calendar, color: "text-[#F59E0B]", bg: "bg-[#F59E0B]/10" },
  ];
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="bg-white rounded-[28px] p-8 border border-[#F0F1F3]">
            ...
            <div className="flex items-end justify-center gap-10 mb-6">
              {[
                { week: "Week 1", height: "h-20", color: "bg-[#E5E7EB]", width: "w-14" },
                { week: "Week 4", height: "h-28", color: "bg-[#4A90E2]", width: "w-14" },
                { week: "Week 8", height: "h-36", color: "bg-[#2ECC71]", width: "w-14" },
              ].map((stage, index) => (
            ...
            <div className="bg-[#FAFBFC] rounded-[20px] p-5 mt-7 border border-[#F0F1F3]">
              <div className="flex items-center justify-between mb-3">
                <span className="text-[15px] text-[#6B7280] font-semibold">Overall Progress</span>
                <span className="text-[17px] font-bold text-[#2ECC71]">75%</span>
              </div>
                ...
                <div key={index} className="flex flex-col items-center gap-3 flex-1">
                  <div className="w-full flex items-end justify-center h-40">
                    <div
                      ...
                      style={{
                        height: day.completed ? `${(day.value / 100) * 100}%` : '15%',
                      }}
                    />
                  </div>
                  <span
