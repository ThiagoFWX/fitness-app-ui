            ...
            <div className="flex items-center justify-between mb-5">
              <div className="flex items-center gap-4">
                <div className="w-16 h-16 bg-white rounded-[20px] flex items-center justify-center shadow-[0_4px_12px_rgba(0,0,0,0.1)]">
                  <Flame className="w-9 h-9 text-[#F59E0B]" strokeWidth={2.5} />
                </div>
                <div>
                  <div className="text-[40px] font-bold text-white tracking-tight leading-none">5</div>
                  <div className="text-[15px] text-white/80 font-medium mt-1">Day Streak</div>
                </div>
              </div>
              <div className="text-right">
                <div className="text-[15px] text-white/90 mb-1 font-medium">Keep going!</div>
