            ...
            <div className="p-7">
              ...
              <div className="flex gap-0 p-1 bg-[#FAFBFC] rounded-[20px] border border-[#F0F1F3]">
                <div className="flex-1 text-center py-4">
                  <div className="text-[24px] font-bold text-[#2ECC71] tracking-tight">
                    420
                  </div>
                  <div className="text-[13px] text-[#9CA3AF] font-medium mt-0.5">
                    Calories
                  </div>
                </div>
                <div className="w-px bg-[#E5E7EB]" />
                <div className="flex-1 text-center py-4">
                  <div className="text-[24px] font-bold text-[#4A90E2] tracking-tight">
                    25g
                  </div>
                  <div className="text-[13px] text-[#9CA3AF] font-medium mt-0.5">
                    Protein
                ...
                <div className="w-px bg-[#E5E7EB]" />
                <div className="flex-1 text-center py-4">
                  <div className="text-[24px] font-bold text-[#F59E0B] tracking-tight">
                    15g
                  </div>
                  <div className="text-[13px] text-[#9CA3AF] font-medium mt-0.5">
                    Fat
